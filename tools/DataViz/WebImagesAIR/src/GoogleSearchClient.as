package 
{
	...
	public class GoogleSearchClient extends EventDispatcher
	{
		...
		public var baseImageAPIURL:String = "https://ajax.googleapis.com/ajax/services/search/images?v=1.0&rsz=large&q=";
		
		private var linksLoaders:Vector.<URLLoader>;
		private var imgLoaders:Vector.<URLLoader>;
		
		private var numPages:int = 6; //X pages * 8 result per page
		...
		private function imgLoaderComplete(e:Event):void 
		{
			...
			var results:Array = data.responseData.results;
			/*
